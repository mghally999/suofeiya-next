...
export const projectSlides: ProjectSlide[] = [
  {
    category: "APARTMENT",
    eyebrow: "Apartment Project · HH",
    project: "HADLEY HEIGHTS · DUBAI",
    location: "Dubai, United Arab Emirates · 2024",
    copy: "Design & Build one-stop solution modern simplicity, artistic textured surfaces and custom hardware across every Dubai unit.",
    image: "/projects/Hadley Heights/01.jpg",
    href: "/projects/gh-apartment",
  },
  {
    category: "RESIDENCE",
    eyebrow: "RESIDENCE PROJECT · OLIVO PARK",
    project: "OLIVO RESIDENCE  · DUBAI",
    location: "Dubai, United Arab Emirates · 2024",
    copy: "Suite grade wardrobe and dressing table program with modern luxury, curved process, plywood + wax-wood veneer lacquer finish.",
    image: "/projects/Olivo Residence/01.jpg",
    href: "/projects/sls-hotel",
  },
  {
    category: "HOTEL",
    eyebrow: "HOTEL PROJECT ",
    project: "ST. REGIS HOTEL · DOHA",
    location: "Doha, Qatar · 2022",
    copy: "Doha hotel fit-out Kitchen Cabinet + Wardrobe in natural walnut veneer with solid-wood lipping, on an E0-melamine carcass matched to the veneer.",
    image: "/projects/St. Regis Hotel/01.jpg",
    href: "/projects/st-hotel",
  },
  {
    category: "APARTMENT",
    eyebrow: "Apartment Project · AR",
    project: "AVENUE RESIDENCE · AL FURJAN",
    location: "Al Furjan, Dubai · 450 units · 2022",
    copy: "A 450-unit Cairo apartment program delivered on a single Suofeiya whole-house specification — Kitchen Cabinet + Vanity Cabinet on NAF / SGS board.",
    image: "/projects/Avenue Residence/01.jpg",
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: "Apartment",
    city: "Cairo, Egypt · 450 units",
    image: "/projects/nc-apartment/01.jpg",
    span: "span-5",
  },
  {
    slug: "serviced-apartments",
    title: "Serviced Apartments — Kitchen & Wardrobe",
    category: "Apartment",
    city: "Mid-rise · 320 units",
    image: IMG.kitchenCabinets,
    span: "span-6",
  },
  {
    slug: "urban-residences",
    title: "Urban Residences — Whole-House",
    category: "Apartment",
    city: "Tower · 240 units",
    image: IMG.livingRoom,
    span: "span-6",
  },
  ...
  {
    slug: "business-hotel",
    title: "Business Hotel — Guestroom Wardrobe",
    category: "Hotel",
    city: "Hospitality · 180 keys",
    image: IMG.bedroom,
    span: "span-4",
  },
  {
    slug: "resort-villas",
    title: "Resort Villas — Door & Vanity",
    category: "Hotel",
    city: "Resort · 60 villas",
    image: IMG.bathroom,
    span: "span-8",
  },
  ...
  /* Villa program */
  {
    ...
    title: "Private Villa — Kitchen Cabinet",
    category: "Villa",
    city: "Private residence",
    image: IMG.kitchen,
    span: "span-6",
  },
  {
    slug: "villa-whole-house",
    title: "Villa — Whole-House Joinery",
    category: "Villa",
    city: "Private residence",
    image: IMG.servicesHome,
    span: "span-6",
  ...
  /* Pavilions (VR Showroom) */
  {
    ...
    title: "Chic Living Pavilion (A1)",
    category: "Villa",
    city: "VR Showroom · 3D walk",
    image: IMG.livingRoom,
    span: "span-4",
  },
  {
    slug: "vogue-life-pavilion",
    title: "Vogue Life Pavilion (A2)",
    category: "Villa",
    city: "VR Showroom · 3D walk",
    image: IMG.bedroom,
    span: "span-8",
  ...
  {
    slug: "luxury-pavilion",
    title: "Luxury Pavilion (B1)",
    category: "Villa",
    city: "VR Showroom · 3D walk",
    image: IMG.bathroom,
    span: "span-5",
  ...
  },
  {
    ...
    title: "Corporate Office — Built-In Furniture",
    category: "Office",
    city: "Workplace fit-out",
    image: IMG.office,
    span: "span-6",
  },
  {
    slug: "design-studio-cabinetry",
    title: "Design Studio — Reception Joinery",
    category: "Office",
    city: "Workplace fit-out",
    image: IMG.exterior,
    span: "span-6",
...
export const manufacturingBases: BaseNode[] = [
  {
    city: "Guangzhou",
    region: "Headquarters · China",
    focus: "Kitchen & Wardrobe R&D, prototype lines",
    area: "320,000 m²",
  },
  {
    city: "Chengxi",
    region: "Zengcheng · China",
    focus: "Wardrobe & whole-house joinery",
    area: "180,000 m²",
  },
  {
    city: "Huanggang",
    region: "Hubei · China",
    focus: "Bathroom Vanity & moisture-resistant board",
    area: "160,000 m²",
  },
  {
    city: "Yiyang",
    region: "Hunan · China",
    focus: "Interior Door manufacture & finishing",
    area: "120,000 m²",
  },
  {
    city: "Yulin",
    region: "Guangxi · China",
    focus: "Loose Furniture & frame programs",
    area: "90,000 m²",
  },
  {
    city: "Chenzhou",
    region: "Hunan · China",
    focus: "Hardware & accessories",
    area: "70,000 m²",
  },
  {
    city: "Foshan",
    region: "Guangdong · China",
    focus: "Kitchen Cabinet expansion line",
    area: "110,000 m²",
  },
  {
    city: "Lecong",
    region: "Guangdong · China",
    focus: "Whole-house assembly + shipping",
    area: "95,000 m²",
  },
];
...
export const certifications: Cert[] = [
  {
    code: "NAF",
    title: "No Added Formaldehyde",
    detail: "Industry-leading NAF-grade boards across the full product range.",
  },
  {
    code: "SGS",
    title: "Quality Certification",
    detail:
      "Third-party quality assurance across raw material, line and finish.",
  },
  {
    code: "CARB P2",
    title: "California Air Resources Board",
    detail: "Phase-2 emissions compliance for export markets.",
  },
  {
    code: "ISO 9001",
    title: "Quality Management System",
    detail: "Audited quality management across all manufacturing bases.",
  },
  {
    code: "ISO 14001",
    title: "Environmental Management",
    detail: "Process-wide environmental management standard.",
  },
  {
    code: "FSC",
    title: "Forest Stewardship Council",
    detail: "Responsible-source timber and board certifications.",
  },
  {
    code: "Red Dot",
    title: "Product Design Award",
    detail: "Recognised in the Red Dot international product-design awards.",
  },
  {
    code: "iF",
    title: "iF Design Award",
    detail: "iF Award — global furniture and product-design recognition.",
  },
];
...
const gallery = (slug: string, count: number) =>
  range(count).map(
    (i) => `/projects/${slug}/${String(i).padStart(2, "0")}.jpg`,
  );
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    body: "A Kuala Lumpur apartment program delivered under one Suofeiya specification — kitchen, wardrobe and built-in furniture drawn in DIYHome 3D, manufactured on Industry 4.0 lines and installed by Suofeiya crews. Modern, artistic, highly textured surfaces with hardware bespoke to the program.",
    metrics: [
  ...
  },
  {
    ...
    body: "A suite-grade joinery program for the SLS Hotel in Kuala Lumpur. Modern-luxury wardrobes and dressing tables manufactured in plywood + wax-wood veneer with lacquer, drawn around the suite architecture and installed by Suofeiya site crews.",
    metrics: [
      { label: "Location", value: "Kuala Lumpur" },
  ...
  },
  {
    ...
    body: "450 apartment units in Cairo, Egypt — kitchen cabinets and vanity cabinets manufactured under one Suofeiya whole-house specification. Boards ship NAF / SGS formaldehyde-free grade; carcasses are sequenced and labelled to the room before they leave the plant.",
    metrics: [
  ...
  },
  {
    ...
    body: "A suite-grade fit-out for the ST Hotel in Doha — kitchen cabinetry and wardrobes built in natural walnut veneer with solid-wood lipping, on an E0-melamine carcass matched to the walnut texture. Delivered front-to-back under one Suofeiya contract.",
    metrics: [
  ...
  },
  {
    ...
    feature:
      "Walk-through 3D pavilion presenting Suofeiya whole-house design as a single architectural moment.",
    ...
    body: "A1 Chic Living captures Suofeiya in a single room — kitchen, wardrobe and loose furniture, all designed and manufactured by one team, all walk-throughable in DIYHome.",
    metrics: [
  ...
  },
  {
    ...
    feature:
      "Dressing-room pavilion rendered as a full architectural experience with browsable Suofeiya material samples.",
    delivered: "Live · 3D walk-through",
    image: IMG.bedroom,
    gallery: [
      IMG.bedroom,
    ...
    body: "A2 Vogue Life is the dressing-room pavilion — Suofeiya’s closet program rendered as a full architectural experience, with material samples accessible inside the 3D walk-through.",
    metrics: [
...
/* ===== Top nav — mirrors the live global.suofeiya.com structure =====
   Split into two flanking groups either side of the centred wordmark:
   `navLeft` sits before the logo, `navRight` after it. `nav` is the
   flat concatenation, kept for the mobile menu which renders one list. */
...
export const nav = [...navLeft, ...navRight] as const;
